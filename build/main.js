...
var _kbsymanz$midwife_emr_internal_docs$Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {mdl: a, selectedTab: b, selectedPage: c, windowSize: d, eth0IP: e, wlan0IP: f, hostname: g};
	});
var _kbsymanz$midwife_emr_internal_docs$Model$WindowSize = F2(
	function (a, b) {
		return {width: a, height: b};
	});
var _kbsymanz$midwife_emr_internal_docs$Model$InitialParams = F3(
	function (a, b, c) {
		return {height: a, width: b, hostname: c};
	});
var _kbsymanz$midwife_emr_internal_docs$Model$VerbageRecord = F3(
	function (a, b, c) {
		return {body: a, title: b, teaser: c};
	});
var _kbsymanz$midwife_emr_internal_docs$Model$ServerInfo = F2(
	function (a, b) {
		return {eth0IP: a, wlan0IP: b};
	});
var _kbsymanz$midwife_emr_internal_docs$Model$TrainingPage = {ctor: 'TrainingPage'};
var _kbsymanz$midwife_emr_internal_docs$Model$HowPage = {ctor: 'HowPage'};
var _kbsymanz$midwife_emr_internal_docs$Model$FeaturesPage = {ctor: 'FeaturesPage'};
var _kbsymanz$midwife_emr_internal_docs$Model$WhatIsPage = {ctor: 'WhatIsPage'};
var _kbsymanz$midwife_emr_internal_docs$Model$MainPage = {ctor: 'MainPage'};
var _kbsymanz$midwife_emr_internal_docs$Model$LearnTab = {ctor: 'LearnTab'};
var _kbsymanz$midwife_emr_internal_docs$Model$SetupTab = {ctor: 'SetupTab'};

var _kbsymanz$midwife_emr_internal_docs$Msg$SetHostname = function (a) {
	return {ctor: 'SetHostname', _0: a};
};
var _kbsymanz$midwife_emr_internal_docs$Msg$ReceiveServerInfo = function (a) {
	return {ctor: 'ReceiveServerInfo', _0: a};
};
var _kbsymanz$midwife_emr_internal_docs$Msg$ReceiveServerError = function (a) {
	return {ctor: 'ReceiveServerError', _0: a};
};
var _kbsymanz$midwife_emr_internal_docs$Msg$FetchServerInfo = function (a) {
	return {ctor: 'FetchServerInfo', _0: a};
};
var _kbsymanz$midwife_emr_internal_docs$Msg$GoToTop = function (a) {
	return {ctor: 'GoToTop', _0: a};
};
var _kbsymanz$midwife_emr_internal_docs$Msg$ViewPage = function (a) {
	return {ctor: 'ViewPage', _0: a};
};
var _kbsymanz$midwife_emr_internal_docs$Msg$WindowResize = function (a) {
	return {ctor: 'WindowResize', _0: a};
};
var _kbsymanz$midwife_emr_internal_docs$Msg$SelectTab = function (a) {
	return {ctor: 'SelectTab', _0: a};
};
var _kbsymanz$midwife_emr_internal_docs$Msg$Mdl = function (a) {
...
var _kbsymanz$midwife_emr_internal_docs$Verbage$viewSetupCAInstructionsAndroid = '\n\n##### Android Tablets and Phones\n\n**See below for iPhone and iPad**\n\n\n\n    ';
...
var _kbsymanz$midwife_emr_internal_docs$Verbage$setupPageCards = _elm_lang$core$Native_List.fromArray(
	[
		...
		{body: _kbsymanz$midwife_emr_internal_docs$Verbage$viewSetupCAInstructionsAndroid, title: 'Install a CA Certificate in an Android device', teaser: '\n\nFind out how to install the CA certificate in your Android phone or tablet.\n\n        '},
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_debois$elm_mdl$Material_Color$text(headColor)
								]),
							_elm_lang$core$Native_List.fromArray(
								[
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_debois$elm_mdl$Material_Color$text(textColor),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('cardText')
									]),
								content)
							]))
					]),
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_kbsymanz$midwife_emr_internal_docs$Msg$ViewPage(page))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Find out more')
									]))
							]))
					])));
	});
var _kbsymanz$midwife_emr_internal_docs$View_ops = _kbsymanz$midwife_emr_internal_docs$View_ops || {};
_kbsymanz$midwife_emr_internal_docs$View_ops[':>'] = F2(
	function (f, x) {
		return f(x);
	});
var _kbsymanz$midwife_emr_internal_docs$View$titleToId = F2(
	function (title, appendage) {
		return A2(
			_elm_lang$core$String$append,
			appendage,
			_elm_lang$core$Basics$toString(
				_jergason$elm_hash$Hash$hash(title)));
	});
var _kbsymanz$midwife_emr_internal_docs$View$midwifeLink = function (hostname) {
	return A2(_elm_lang$core$Basics_ops['++'], 'https://', hostname);
};
var _kbsymanz$midwife_emr_internal_docs$View$headerLink = function (model) {
	var isLink = (_elm_lang$core$Native_Utils.cmp(
		_elm_lang$core$String$length(model.hostname),
		0) > 0) && (_elm_lang$core$Native_Utils.eq(model.hostname, model.wlan0IP) || _elm_lang$core$Native_Utils.eq(model.hostname, model.eth0IP));
	var link = isLink ? A2(
		_debois$elm_mdl$Material_Layout$link,
		_elm_lang$core$Native_List.fromArray(
			[
				_debois$elm_mdl$Material_Layout$href(
				_kbsymanz$midwife_emr_internal_docs$View$midwifeLink(model.hostname)),
				_debois$elm_mdl$Material_Color$background(_debois$elm_mdl$Material_Color$accentContrast),
				_debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$accent)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Go to Midwife-EMR')
...
var _kbsymanz$midwife_emr_internal_docs$View$headerSmall = F2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_kbsymanz$midwife_emr_internal_docs$View$headerLink(model)
							]))
					]))
			]);
		return contents;
	});
var _kbsymanz$midwife_emr_internal_docs$View$tabSpan = function (lbl) {
	return A2(
		_debois$elm_mdl$Material_Options$span,
		_elm_lang$core$Native_List.fromArray(
			[
				_debois$elm_mdl$Material_Options$cs('tabLabel')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _kbsymanz$midwife_emr_internal_docs$View$tabs = function (labels) {
	return {
		ctor: '_Tuple2',
		_0: A2(_elm_lang$core$List$map, _kbsymanz$midwife_emr_internal_docs$View$tabSpan, labels),
		_1: _elm_lang$core$Native_List.fromArray(
			[
				_debois$elm_mdl$Material_Color$background(
				A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$LightBlue, _debois$elm_mdl$Material_Color$S700))
			])
	};
};
var _kbsymanz$midwife_emr_internal_docs$View_ops = _kbsymanz$midwife_emr_internal_docs$View_ops || {};
...
var _kbsymanz$midwife_emr_internal_docs$View$header = F2(
	function (title, model) {
		return _elm_lang$core$Native_List.fromArray(
			[
				A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_kbsymanz$midwife_emr_internal_docs$View_ops['=>'], 'padding', '2rem')
									]))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _kbsymanz$midwife_emr_internal_docs$View$getIntTab = function (num) {
	var _p0 = num;
	switch (_p0) {
		case 0:
			return _kbsymanz$midwife_emr_internal_docs$Model$SetupTab;
		case 1:
			return _kbsymanz$midwife_emr_internal_docs$Model$LearnTab;
		default:
			return _kbsymanz$midwife_emr_internal_docs$Model$LearnTab;
	}
};
var _kbsymanz$midwife_emr_internal_docs$View$getTabInt = function (tab) {
	var _p1 = tab;
	if (_p1.ctor === 'SetupTab') {
		return 0;
	} else {
		return 1;
	}
};
var _kbsymanz$midwife_emr_internal_docs$View$topBtn = 5;
var _kbsymanz$midwife_emr_internal_docs$View$learnBackBtn = 4;
var _kbsymanz$midwife_emr_internal_docs$View$viewDetailPage = F7(
	function (title, cards, backColor, titleColor, textColor, isTopLevel, model) {
		...
		var toc = A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												generateId(
													A2(_elm_lang$core$Basics_ops['++'], '#', card.title))),
												_elm_lang$html$Html_Attributes$style(
												_elm_lang$core$Native_List.fromArray(
													[
														A2(_kbsymanz$midwife_emr_internal_docs$View_ops['=>'], 'color', '#0288D1')
													]))
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text(card.title)
											])),
										A2(
			...
			cards);
		var divId = A2(_kbsymanz$midwife_emr_internal_docs$View$titleToId, title, 'divId');
		var body = A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (idx, card) {
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_debois$elm_mdl$Material_Options$css, 'width', '100%'),
										_debois$elm_mdl$Material_Color$background(backColor),
										_debois$elm_mdl$Material_Card$border
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_debois$elm_mdl$Material_Color$text(titleColor),
														_debois$elm_mdl$Material_Options$attribute(
														_elm_lang$html$Html_Attributes$id(
															generateId(card.title)))
													]),
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html$text(card.title)
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_debois$elm_mdl$Material_Options$cs('go-to-top-button')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												A5(
												...
												_kbsymanz$midwife_emr_internal_docs$Msg$Mdl,
												_elm_lang$core$Native_List.fromArray(
													[_kbsymanz$midwife_emr_internal_docs$View$topBtn]),
												model.mdl,
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white),
														_debois$elm_mdl$Material_Button$onClick(
														_kbsymanz$midwife_emr_internal_docs$Msg$GoToTop(divId))
													]),
												_elm_lang$core$Native_List.fromArray(
													[
														_debois$elm_mdl$Material_Icon$i('arrow_upward')
													]))
											]))
									]))
							]));
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$id(divId)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A5(
					...
					_kbsymanz$midwife_emr_internal_docs$Msg$Mdl,
					_elm_lang$core$Native_List.fromArray(
						[_kbsymanz$midwife_emr_internal_docs$View$learnBackBtn]),
					model.mdl,
					_elm_lang$core$Native_List.fromArray(
						[
							_debois$elm_mdl$Material_Button$ripple,
							...
							_debois$elm_mdl$Material_Button$onClick(
							_kbsymanz$midwife_emr_internal_docs$Msg$ViewPage(_kbsymanz$midwife_emr_internal_docs$Model$MainPage)),
							A2(_debois$elm_mdl$Material_Options$when, _debois$elm_mdl$Material_Button$disabled, isTopLevel),
							A2(
							_debois$elm_mdl$Material_Options$when,
...
var _kbsymanz$midwife_emr_internal_docs$View$viewHow = function (model) {
	return A7(
		_kbsymanz$midwife_emr_internal_docs$View$viewDetailPage,
		'How do I ... ?',
		_kbsymanz$midwife_emr_internal_docs$Verbage$howPageCards(model),
		_debois$elm_mdl$Material_Color$primary,
		_debois$elm_mdl$Material_Color$accent,
		_debois$elm_mdl$Material_Color$primaryContrast,
		false,
		model);
};
var _kbsymanz$midwife_emr_internal_docs$View$viewUse = function (model) {
	return A7(_kbsymanz$midwife_emr_internal_docs$View$viewDetailPage, 'Setting up Midwife-EMR', _kbsymanz$midwife_emr_internal_docs$Verbage$setupPageCards, _debois$elm_mdl$Material_Color$primary, _debois$elm_mdl$Material_Color$accent, _debois$elm_mdl$Material_Color$primaryContrast, true, model);
};
var _kbsymanz$midwife_emr_internal_docs$View$viewWhatIs = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _kbsymanz$midwife_emr_internal_docs$View$viewFeatures = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _kbsymanz$midwife_emr_internal_docs$View$viewTraining = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
...
var _kbsymanz$midwife_emr_internal_docs$View$learnTrainingBtn = 3;
var _kbsymanz$midwife_emr_internal_docs$View$viewLearnTrainingCard = function (model) {
	var title = 'Training';
	var contents = A7(_kbsymanz$midwife_emr_internal_docs$View$cardContents, _kbsymanz$midwife_emr_internal_docs$View$learnTrainingBtn, _kbsymanz$midwife_emr_internal_docs$Model$TrainingPage, model, _debois$elm_mdl$Material_Color$accent, _debois$elm_mdl$Material_Color$primaryContrast, title, _kbsymanz$midwife_emr_internal_docs$Verbage$trainingIntro);
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_debois$elm_mdl$Material_Card$view,
...
var _kbsymanz$midwife_emr_internal_docs$View$learnHowToBtn = 2;
var _kbsymanz$midwife_emr_internal_docs$View$viewLearnHowToCard = function (model) {
	var title = 'How do I ...?';
	var contents = A7(_kbsymanz$midwife_emr_internal_docs$View$cardContents, _kbsymanz$midwife_emr_internal_docs$View$learnHowToBtn, _kbsymanz$midwife_emr_internal_docs$Model$HowPage, model, _debois$elm_mdl$Material_Color$accent, _debois$elm_mdl$Material_Color$primaryContrast, title, _kbsymanz$midwife_emr_internal_docs$Verbage$howIntro);
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_debois$elm_mdl$Material_Card$view,
...
var _kbsymanz$midwife_emr_internal_docs$View$learnFeaturesBtn = 1;
var _kbsymanz$midwife_emr_internal_docs$View$viewLearnFeaturesCard = function (model) {
	var title = 'Features';
	var contents = A7(_kbsymanz$midwife_emr_internal_docs$View$cardContents, _kbsymanz$midwife_emr_internal_docs$View$learnFeaturesBtn, _kbsymanz$midwife_emr_internal_docs$Model$FeaturesPage, model, _debois$elm_mdl$Material_Color$white, _debois$elm_mdl$Material_Color$accent, title, _kbsymanz$midwife_emr_internal_docs$Verbage$featuresIntro);
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_debois$elm_mdl$Material_Card$view,
...
var _kbsymanz$midwife_emr_internal_docs$View$learnWhatIsBtn = 0;
var _kbsymanz$midwife_emr_internal_docs$View$viewLearnWhatIsCard = function (model) {
	var title = 'What is Midwife-EMR?';
	var contents = A7(_kbsymanz$midwife_emr_internal_docs$View$cardContents, _kbsymanz$midwife_emr_internal_docs$View$learnWhatIsBtn, _kbsymanz$midwife_emr_internal_docs$Model$WhatIsPage, model, _debois$elm_mdl$Material_Color$primaryDark, _debois$elm_mdl$Material_Color$accentContrast, title, _kbsymanz$midwife_emr_internal_docs$Verbage$learnIntro);
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_debois$elm_mdl$Material_Card$view,
...
var _kbsymanz$midwife_emr_internal_docs$View$viewLearn = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_kbsymanz$midwife_emr_internal_docs$View$viewLearnWhatIsCard(model)),
						A2(
						_debois$elm_mdl$Material_Grid$cell,
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_kbsymanz$midwife_emr_internal_docs$View$viewLearnFeaturesCard(model)),
						A2(
						_debois$elm_mdl$Material_Grid$cell,
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_kbsymanz$midwife_emr_internal_docs$View$viewLearnHowToCard(model)),
						A2(
						_debois$elm_mdl$Material_Grid$cell,
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_kbsymanz$midwife_emr_internal_docs$View$viewLearnTrainingCard(model))
					]))
			]));
};
var _kbsymanz$midwife_emr_internal_docs$View$viewMain = function (model) {
	var _p2 = model.selectedTab;
	if (_p2.ctor === 'SetupTab') {
		return _kbsymanz$midwife_emr_internal_docs$View$viewUse(model);
	} else {
		return _kbsymanz$midwife_emr_internal_docs$View$viewLearn(model);
	}
};
var _kbsymanz$midwife_emr_internal_docs$View$view = function (model) {
	var main = function () {
		var _p3 = model.selectedPage;
		switch (_p3.ctor) {
			case 'MainPage':
				return _kbsymanz$midwife_emr_internal_docs$View$viewMain;
			case 'WhatIsPage':
				return _kbsymanz$midwife_emr_internal_docs$View$viewWhatIs;
			case 'FeaturesPage':
				return _kbsymanz$midwife_emr_internal_docs$View$viewFeatures;
			case 'HowPage':
				return _kbsymanz$midwife_emr_internal_docs$View$viewHow;
			default:
				return _kbsymanz$midwife_emr_internal_docs$View$viewTraining;
		}
	}();
	return A4(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_kbsymanz$midwife_emr_internal_docs$View$getTabInt(model.selectedTab)),
				_debois$elm_mdl$Material_Layout$onSelectTab(
				function (t) {
					return _kbsymanz$midwife_emr_internal_docs$Msg$SelectTab(
						_kbsymanz$midwife_emr_internal_docs$View$getIntTab(t));
				})
			]),
		{
			header: A2(_kbsymanz$midwife_emr_internal_docs$View$headerSmall, 'Midwife-EMR', model),
			drawer: _elm_lang$core$Native_List.fromArray(
				[]),
			tabs: _kbsymanz$midwife_emr_internal_docs$View$tabs(
				_elm_lang$core$Native_List.fromArray(
					['Setup', 'Learn'])),
...
var _kbsymanz$midwife_emr_internal_docs$Ports$scrollParent = _elm_lang$core$Native_Platform.outgoingPort(
	'scrollParent',
	function (v) {
		return v;
	});

var _kbsymanz$midwife_emr_internal_docs$Main$infoDecoder = A3(
	...
	A3(
		...
		'eth0',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_kbsymanz$midwife_emr_internal_docs$Model$ServerInfo)));
var _kbsymanz$midwife_emr_internal_docs$Main$apiEndPoint = '/getInfo.json';
var _kbsymanz$midwife_emr_internal_docs$Main$fetchServerInfo = A3(
	_elm_lang$core$Task$perform,
	_kbsymanz$midwife_emr_internal_docs$Msg$ReceiveServerError,
	_kbsymanz$midwife_emr_internal_docs$Msg$ReceiveServerInfo,
	A2(_evancz$elm_http$Http$get, _kbsymanz$midwife_emr_internal_docs$Main$infoDecoder, _kbsymanz$midwife_emr_internal_docs$Main$apiEndPoint));
var _kbsymanz$midwife_emr_internal_docs$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
				var _p1 = A2(_elm_lang$core$Debug$log, 'NoOp', 'has been called');
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					_elm_lang$core$Native_List.fromArray(
			...
			case 'SelectTab':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{selectedTab: _p0._0, selectedPage: _kbsymanz$midwife_emr_internal_docs$Model$MainPage}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'WindowResize':
				var _p2 = A2(_elm_lang$core$Debug$log, 'windowSize', model.windowSize);
			...
			case 'GoToTop':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _kbsymanz$midwife_emr_internal_docs$Ports$scrollParent(_p0._0)
				};
			case 'FetchServerInfo':
				return A2(
					...
					model,
					_elm_lang$core$Native_List.fromArray(
						[_kbsymanz$midwife_emr_internal_docs$Main$fetchServerInfo]));
			case 'ReceiveServerError':
				var _p3 = A2(_elm_lang$core$Debug$log, 'FetchServerError', _p0._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					_elm_lang$core$Native_List.fromArray(
			...
			case 'ReceiveServerInfo':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{eth0IP: _p4.eth0IP, wlan0IP: _p4.wlan0IP}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return A2(
...
var _kbsymanz$midwife_emr_internal_docs$Main$windowSizeEmpty = {width: 0, height: 0};
var _kbsymanz$midwife_emr_internal_docs$Main$model = {mdl: _debois$elm_mdl$Material$model, selectedTab: _kbsymanz$midwife_emr_internal_docs$Model$SetupTab, selectedPage: _kbsymanz$midwife_emr_internal_docs$Model$MainPage, windowSize: _kbsymanz$midwife_emr_internal_docs$Main$windowSizeEmpty, eth0IP: '', wlan0IP: '', hostname: ''};
var _kbsymanz$midwife_emr_internal_docs$Main$init = function (initialParams) {
	var hostname = A2(_elm_lang$core$Maybe$withDefault, '', initialParams.hostname);
	var width = A2(_elm_lang$core$Maybe$withDefault, 0, initialParams.width);
	var height = A2(_elm_lang$core$Maybe$withDefault, 0, initialParams.height);
	var newModel = _elm_lang$core$Native_Utils.update(
		_kbsymanz$midwife_emr_internal_docs$Main$model,
		{
			windowSize: A2(_kbsymanz$midwife_emr_internal_docs$Model$WindowSize, height, width),
			hostname: hostname
		});
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_debois$elm_mdl$Material$init(_kbsymanz$midwife_emr_internal_docs$Msg$Mdl),
				_kbsymanz$midwife_emr_internal_docs$Main$fetchServerInfo
			]));
};
var _kbsymanz$midwife_emr_internal_docs$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _kbsymanz$midwife_emr_internal_docs$Main$init,
			view: _kbsymanz$midwife_emr_internal_docs$View$view,
			subscriptions: function (model) {
				return _elm_lang$core$Platform_Sub$batch(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_debois$elm_mdl$Material$subscriptions, _kbsymanz$midwife_emr_internal_docs$Msg$Mdl, model),
							A2(_debois$elm_mdl$Material_Menu$subs, _kbsymanz$midwife_emr_internal_docs$Msg$Mdl, model.mdl),
							_elm_lang$window$Window$resizes(_kbsymanz$midwife_emr_internal_docs$Msg$WindowResize),
							A2(_elm_lang$core$Time$every, 15 * _elm_lang$core$Time$second, _kbsymanz$midwife_emr_internal_docs$Msg$FetchServerInfo)
						]));
			},
			update: _kbsymanz$midwife_emr_internal_docs$Main$update
		}),
	flags: A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(
					...
					return A2(
						...
						function (width) {
							return _elm_lang$core$Json_Decode$succeed(
								{height: height, hostname: hostname, width: width});
						});
				});
		})
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _kbsymanz$midwife_emr_internal_docs$Main$main === 'undefined' ? null : _kbsymanz$midwife_emr_internal_docs$Main$main);
